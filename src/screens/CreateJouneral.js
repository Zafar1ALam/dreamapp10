...
const CreateJouneral = ({ route, navigation }) => {
    ...
    const [stateTitle, setStateTitle] = useState(varRouteTitle);
    const [stateDescription, setStateDescription] = useState(varRouteDescription);
    const [stateTime, setStateTime] = useState('')
    const [stateDate, setStateDate] = useState('')
    const [stateDreamType, setStateDreamType] = useState("Nightmare");
    const [stateMood, setStateMood] = useState('Select Mood');
    const [stateSleep, setStateSleep] = useState('Select Sleep');
    const [stateClarity, setStateClarity] = useState('Select Clarity');
    ...
    const saveJournal = () => {
        ...
        if (stateClarity == 'Select Clarity') {
        ...
        if (stateTime != '' && stateDescription != '' && stateClarity != "Select Clarity" && stateSleep != "Select Sleep"
            && stateMood != "Select Mood" && stateDate != "" && stateTime != ""
...
CreateJouneral.propTypes = {

};

export default CreateJouneral;
